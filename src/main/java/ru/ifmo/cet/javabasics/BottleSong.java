...
public class BottleSong {
    ...
    private String writtenNum(int Number){
        ...
        if (Desyatki == 1){
            WrittenNumber = getTeenNumber(Edinitsi);
        }else {
            Secondpart = getSecondPart(Edinitsi);
            Firstpart = getFirstPart(Desyatki);
            WrittenNumber = Firstpart + Secondpart;
        }
        return WrittenNumber;
    }

    private String getFirstPart(int Desyatki){
        String Firstpart;
        switch (Desyatki) {
            case 2:
                Firstpart = "twenty ";
    ...
    private String getSecondPart(int Edinitsy){
        String Secondpart;
        switch (Edinitsy) {
            case 1:
                Secondpart = "one ";
